...
public class BoardController {
    ...
    public CommonResponse<?> getBoards(@PathVariable Long teamId, @RequestParam int pageNum, @RequestParam int pageSize, @RequestParam BoardCategory category){
        return boardService.getBoards(teamId, pageNum, pageSize, category);
    }
